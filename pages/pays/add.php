...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO familles_topo (materiel, abv, active, observation) VALUES (?, ?, ?, ?)";
...
<head>
    ...
    <title>Ajouter une abréviation</title>
    ...
    <?php if ($_SESSION['privilege'] === 'admin') { ?>
            ...
            <div class="right_col" role="main">
                <div class="form-container">
                    <h1>Ajouter une abréviation</h1>
                    <form method="post">
                        <div class="form-group">
                            <label for="materiel">Matériel *</label>
                            <input type="text" id="materiel" name="materiel" required="required" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="abv">Abbréviation *</label>
                            <input type="text" id="abv" name="abv" required="required" class="form-control">
                        </div>
                        <div class="form-group">
