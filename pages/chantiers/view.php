...
$sql = "SELECT c.*, p.pays as pays_name FROM chantiers c 
        ...
        WHERE c.chantier LIKE '%$search%' OR c.code LIKE '%$search%'";
    ...
    <?php if ($_SESSION['privilege'] === 'admin') { ?>
            ...
            <div class="right_col" role="main">
                <div class="table-container">
                    ...
                    <form action="list_chantiers.php" method="GET" class="form-inline">
                        ...
                        <?php if (in_array($_SESSION['privilege'], ['admin', 'utilisateur'])) { ?>
                        <a href="add_chantier.php" class="btn btn-success mb-2">Ajouter</a>
                        <?php } ?>
                    </form>
                        ...
                        <tbody>
                            <?php while($row = $result->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td><?php echo $row['pays_name']; ?></td>
                                    <td><?php echo $row['contact']; ?></td>
                                    <td><?php echo $row['active'] ? 'Oui' : 'Non'; ?></td>
                                    <td><?php echo $row['observation']; ?></td>
                                    <td>
                                    <?php if (in_array($_SESSION['privilege'], ['admin', 'utilisateur'])) { ?>
                                        <a href="edit_chantier.php?id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                                        <?php } ?>
                                        <?php if ($_SESSION['privilege'] === 'admin') { ?>
                                        <a href="delete_chantier.php?id=<?php echo $row['id']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
